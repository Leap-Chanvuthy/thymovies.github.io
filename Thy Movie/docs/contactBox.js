...
function showContactBox(){
    ...
    cntBox.innerHTML = `<div class="contact-box-message">
                                ...
                                <div class="contact-btn">
                                    <a href="https://web.facebook.com/leapchanvuthy" target="_blank" class="contact-btn-1">Facebook<i class="fa-brands fa-facebook-f"></i></a>
                                    <a href="https://t.me/Elon_Thy" target="_blank" class="contact-btn-2">Telegram<i class="fa-brands fa-telegram"></i></a>
                                </div>
                            </div>`;
}
